...
driver_links = webdriver.Chrome(
    executable_path='/home/maxbot/.wdm/drivers/chromedriver/linux64/83.0.4103.39/chromedriver')
...
def extractJobLinks(html):
    ...
    try:
        ...
        job_lists = soup.find("div", {"id": "srp-jobList"}).find_all("div",
                                                                     {"class": "card-panel apply-panel job-apply-card"})
        cnt = 0
